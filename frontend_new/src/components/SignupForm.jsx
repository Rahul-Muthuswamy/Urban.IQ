...
export default function SignupForm({ formData, setFormData, errors, onSubmit, isPending }) {
      ...
      <div className="glass rounded-3xl p-10 md:p-12 lg:p-14 shadow-glass-lg backdrop-blur-xl" style={{ minHeight: "600px" }}>
        ...
        >
          <span className="text-gray-600 text-sm">
            ...
            <Link
              to="/login"
              className="text-accent font-semibold hover:text-primary transition-all duration-300 inline-block hover:scale-105"
            >
              Sign In
            </Link>
          </span>
        ...
        <form onSubmit={onSubmit} className="space-y-7">
          ...
          >
            <label htmlFor="username" className="block mb-3 text-sm md:text-base font-medium text-gray-700">
              Name
            </label>
            <motion.div
        ...
        >
          ...
          <div className="relative flex justify-center items-center">
            ...
            <span className="px-4 bg-transparent text-sm text-gray-500 font-medium">Or register with</span>
